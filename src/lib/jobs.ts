...
// 職種ごとの定義・勤務形態（AIに引用されやすい「○○とは」用の自己完結データ）
// style: 在宅=自宅可 / 店舗=店舗勤務 / 派遣=指定場所へ出向く無店舗型
export const CATEGORY_INFO: Record<string, { summary: string; style: "在宅" | "店舗" | "派遣" }> = {
  chatlady: { summary: "チャットレディは、Webカメラやチャットを通じて画面越しに会話・接客するお仕事です。スマホやPCとネット環境があれば自宅から働け、顔出しなしで始めることもできます。", style: "在宅" },
  "cabaret-club": { summary: "キャバクラは、来店した男性客にドリンクを提供しながら会話で楽しませる夜のお仕事です。指名やインセンティブで収入を伸ばせるのが特徴です。", style: "店舗" },
  "seki-kyaba": { summary: "セクキャバ（セクシーキャバクラ）は、キャバクラより接客の距離が近い形態の夜のお仕事です。その分、時給はキャバクラより高めの傾向があります。", style: "店舗" },
  concafe: { summary: "コンカフェ（コンセプトカフェ）は、特定の世界観やコスチュームでお客様を接客するカフェ形態のお仕事です。昼職感覚で働けるライトな業態として人気です。", style: "店舗" },
  "girls-bar": { summary: "ガールズバーは、カウンター越しにドリンクを作りながら会話で接客するバー形態のお仕事です。カジュアルな雰囲気で未経験から始めやすいのが特徴です。", style: "店舗" },
  gallardo: { summary: "ガールズバーは、カウンター越しにドリンクを作りながら会話で接客するバー形態のお仕事です。カジュアルな雰囲気で未経験から始めやすいのが特徴です。", style: "店舗" },
  lounge: { summary: "ラウンジは、落ち着いた雰囲気のなかで会話を中心に接客する高級志向の夜のお仕事です。客層が良く、無理なく働きやすい環境が多いのが特徴です。", style: "店舗" },
  "mens-esthe": { summary: "メンズエステは、男性向けにマッサージやリラクゼーションを提供するエステのお仕事です。性的サービスを伴わない店舗が中心で、エステ業界の一種として働けます。", style: "店舗" },
  "delivery-health": { summary: "デリヘル（デリバリーヘルス）は、お客様の指定する場所へ出向いて接客する派遣型のお仕事です。店舗を持たない無店舗型で、高収入が期待できる業態です。", style: "派遣" },
  "hitozuma-delivery": { summary: "人妻デリヘルは、既婚女性・大人の女性をコンセプトにしたデリバリー型のお仕事です。落ち着いた年齢層が活躍しやすい業態です。", style: "派遣" },
  "hotel-health": { summary: "ホテヘル（ホテルヘルス）は、ホテルを利用して接客するヘルス業態のお仕事です。", style: "派遣" },
  "hoteto-l": { summary: "ホテル型ヘルスは、ホテルを利用して接客するヘルス業態のお仕事です。", style: "派遣" },
  health: { summary: "ヘルスは、店舗で接客する風俗業態のお仕事です。高収入が期待できる業態のひとつです。", style: "店舗" },
  "fuzoku-esthe": { summary: "風俗エステは、エステ系のサービスを提供する風俗業態のお仕事です。", style: "店舗" },
  "image-club": { summary: "イメクラ（イメージクラブ）は、シチュエーション設定のもとで接客する店舗型の風俗業態です。", style: "店舗" },
  "m-kankan": { summary: "M性感は、男性向けの性感系サービスを提供する風俗業態のお仕事です。", style: "店舗" },
  "ona-club": { summary: "オナクラは、直接的な接触が少ないライトな風俗業態のお仕事です。", style: "店舗" },
  "pink-salon": { summary: "ピンサロは、店舗で接客する風俗業態のお仕事です。", style: "店舗" },
  "sm-club": { summary: "SMクラブは、SMプレイを専門に提供する風俗業態のお仕事です。専門性が高く高収入が期待できます。", style: "店舗" },
  soapland: { summary: "ソープランドは、入浴を伴う店舗型の風俗業態で、業界の中でも高収入が期待できるお仕事です。", style: "店舗" },
};
